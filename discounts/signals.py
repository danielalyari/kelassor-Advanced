...
# NOTE: این signals برای مدل‌های DiscountUsage, DiscountCode, Referral نوشته شده
# که در حال حاضر در پروژه وجود ندارند. اگر این مدل‌ها اضافه شدند، این signals را فعال کنید.
# 
